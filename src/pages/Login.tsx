    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-6">
          ...
          <h2 className="mt-2 text-2xl font-bold text-gray-900">Sign in to LinkedIn</h2>
        </div>
        
        <Card>
          <CardHeader>
            <CardTitle>{isSignup ? "Create a new account" : "Sign in"}</CardTitle>
            <CardDescription>
              {isSignup ? "Create your LinkedIn account" : "Enter your credentials to access your account"}
            </CardDescription>
          </CardHeader>
